...
class FinancialReportController extends Controller
{
    ...
    public function incomeStatementExportExcel($year, $month = null)
    {
        $role = Auth::user();
        $isCompany = $role->hasRole('company');
        $user = Auth::user()->id;
        ...
        return Excel::download(new LaporanLabaRugiExport( 
            $incomeArray, 
            $expenseArray,
            $years, 
            $year, 
            ...
            $company, 
            $othersIncome, 
            $othersExpense ), 'Laporan-Laba-Rugi-Export.xlsx');
    ...
    public function changeInEquityExportExcel($year, $month = null)
    {
        ...
        return Excel::download(new PerubahanEkuitasExport( 
            $equityArray, 
            $saldo_berjalan,
            $company ), 'Laporan-Perubahan-Ekuitas-Export.xlsx');
    ...
    public function balanceSheetExportExcel($year, $month = null)
    {
        $role = Auth::user();
        $isCompany = $role->hasRole('company');
        $user = Auth::user()->id;
